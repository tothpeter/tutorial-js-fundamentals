+function(){
  ...
  function loadPage(xhr, urlToLoad) {
    xhr.onload = function() {
      ...
      window.history.pushState({ pageContent: response }, 'JS Fnd', urlToLoad);
    }
  ...
  document.addEventListener('click', function(e) {
    ...
    if (e.target.nodeName === 'A') {
      ...
      window.history.pushState({ pageContent: document.body.outerHTML}, 'Js FUnd1', document.location.href)
    }
  });
